...
import { Droplets, Calendar, AlertTriangle, Sprout, Sparkles } from "lucide-react";
              ...
              <div className="border-t border-gray-200/50 bg-gray-50/50 backdrop-blur-sm mt-auto dark:border-gray-700/50 dark:bg-gray-700/20">
                <div className="grid grid-cols-3 divide-x divide-gray-200/50 dark:divide-gray-700/50">
                  ...
                  <WaterPlantButton
                    ...
                    compact={true}
                    className={`w-full py-4 border-none rounded-none font-medium transition-all duration-200 text-xs flex items-center justify-center ${
                      isOverdue
                  ...
                  <FertilizePlantButton
                    ...
                    compact={true}
                    className={`w-full py-4 border-none rounded-none font-medium transition-all duration-200 text-xs flex items-center justify-center bg-transparent ${
                      isFertilizerOverdue 
